...
haskellpack:
	make clean
	mkdir xgboost-target
	cd xgboost/subtree/rabit; make clean; cd $(HPWD)
	cp -r xgboost/src xgboost-target/src
	mkdir -p xgboost-target/src/subtree/rabit
	cp -r xgboost/subtree/rabit/include xgboost-target/src/subtree/rabit/include
	cp -r xgboost/subtree/rabit/src 		xgboost-target/src/subtree/rabit/src
	rm -rf xgboost-target/src/subtree/rabit/src/*.o
	mkdir xgboost-target/src/wrapper
	cp wrapper/xgboost_wrapper.h xgboost/src/wrapper
	cp wrapper/xgboost_wrapper.cpp xgboost/src/wrapper
	cp ./LICENSE xgboost-target
